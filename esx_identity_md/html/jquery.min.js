...
!function(global, factory) {
   ...
   * @return {?}
   */
  function add(child, target, results) {
    var key;
    var value;
    if (void 0 === results && 1 === child.nodeType) {
      if (key = "data-" + target.replace(rhyphen, "-$&").toLowerCase(), "string" == typeof(results = child.getAttribute(key))) {
        try {
          /** @type {*} */
          results = "true" === (value = results) || "false" !== value && ("null" === value ? null : value === +value + "" ? +value : trueRE.test(value) ? JSON.parse(value) : value);
        } catch (e) {
        }
        self.set(child, target, results);
      } else {
        results = void 0;
      }
    }
  ...
  function buildFragment(elems, context, result, element, ignored) {
    ...
    for (; elem = results[i++];) {
      if (element && -1 < jQuery.inArray(elem, element)) {
        ...
        if (idx = contains(elem), tmp = getAll(fragment.appendChild(elem), "script"), idx && setGlobalEval(tmp), result) {
          /** @type {number} */
          j = 0;
          for (; elem = tmp[j++];) {
   ...
   */
  function $(elem, e) {
    return callback(elem, "table") && callback(11 !== e.nodeType ? e : e.firstChild, "tr") && jQuery(elem).children("tbody")[0] || elem;
  }
  /**
   * @param {!Element} s
   * @return {?}
  ...
  function domManip(collection, args, callback, ignored) {
    ...
    if (totalItems && (first = (fragment = buildFragment(args, collection[0].ownerDocument, false, collection, ignored)).firstChild, 1 === fragment.childNodes.length && (fragment = first), first || ignored)) {
      ...
      if (tableslen) {
        document = a[a.length - 1].ownerDocument;
   ...
   */
  function each(obj) {
    return Array.isArray(obj) ? obj : "string" == typeof obj && obj.match(value) || [];
  }
  /**
   * @param {string} url
   * @param {!Array} a
  ...
  function addToPrefiltersOrTransports(structure) {
    return function(val, t) {
      ...
      /** @type {number} */
      var c = 0;
      var replies = val.toLowerCase().match(value) || [];
      if (fn(t)) {
        for (; type = replies[c++];) {
          if ("+" === type[0]) {
            type = type.slice(1) || "*";
  ...
  jQuery.extend({
    ...
    map : function(input, fn, val) {
      ...
      if (isArrayLike(input)) {
        inpLen = input.length;
        for (; i < inpLen; i++) {
          if (null != (result = fn(input[i], i, val))) {
            ret.push(result);
          }
        }
      } else {
  ...
  var Sizzle = function(window) {
    ...
    function Sizzle(selector, context, results, seed) {
      ...
      if (!seed && ((context ? context.ownerDocument || context : preferredDoc) !== document && setDocument(context), context = context || document, documentIsHTML)) {
        ...
        if (support.qsa && !tokenCache[selector + " "] && (!rbuggyQSA || !rbuggyQSA.test(selector)) && (1 !== undefined || "object" !== context.nodeName.toLowerCase())) {
          if (newSelector = selector, newContext = context, 1 === undefined && negativeRegex.test(selector)) {
    ...
    /** @type {string} */
    var options = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped";
    /** @type {string} */
    var _test = "[\\x20\\t\\r\\n\\f]";
    /** @type {string} */
    ...
    /** @type {!RegExp} */
    var is_jsonp_re = new RegExp("^" + _test + "*," + _test + "*");
    /** @type {!RegExp} */
    ...
    for (i in support = Sizzle.support = {}, isXML = Sizzle.isXML = function(elem) {
      ...
      return doc !== document && 9 === doc.nodeType && doc.documentElement && (docElem = (document = doc).documentElement, documentIsHTML = !isXML(document), preferredDoc !== document && (subWindow = document.defaultView) && subWindow.top !== subWindow && (subWindow.addEventListener ? subWindow.addEventListener("unload", unloadHandler, false) : subWindow.attachEvent && subWindow.attachEvent("onunload", unloadHandler)), support.attributes = assert(function(elm) {
      ...
      }), support.getById ? (Expr.filter.ID = function(context) {
        ...
        var n = context.replace(value, data);
        return function(elem) {
          var exported = "undefined" != typeof elem.getAttributeNode && elem.getAttributeNode("id");
        ...
        if (!container.querySelectorAll("[selected]").length) {
          rbuggyQSA.push("\\[" + _test + "*(?:value|" + options + ")");
        }
      ...
      if ((elem.ownerDocument || elem) !== document && setDocument(elem), support.matchesSelector && documentIsHTML && !tokenCache[selector + " "] && (!rbuggyMatches || !rbuggyMatches.test(selector)) && (!rbuggyQSA || !rbuggyQSA.test(selector))) {
        try {
      ...
      return 0 < Sizzle(selector, document, null, [elem]).length;
      ...
      preFilter : {
        ATTR : function(result) {
          return result[1] = result[1].replace(value, data), result[3] = (result[3] || result[4] || result[5] || "").replace(value, data), "~=" === result[2] && (result[3] = " " + result[3] + " "), result.slice(0, 4);
        },
      ...
      pseudos : {
        ...
        contains : markFunction(function(widget) {
          return widget = widget.replace(value, data), function(element) {
            return -1 < (element.textContent || $(element)).indexOf(widget);
          };
        }),
        ...
        target : function(target) {
          ...
          return charListNotLatin && charListNotLatin.slice(1) === target.id;
        },
        root : function(elem) {
          return elem === docElem;
        },
    ...
    return setFilters.prototype = Expr.filters = Expr.pseudos, Expr.setFilters = new setFilters, tokenize = Sizzle.tokenize = function(node, rows) {
      var context;
      var match;
      var tokens;
      var type;
      ...
      for (; value;) {
        for (type in context && !(match = is_jsonp_re.exec(value)) || (match && (value = value.slice(match[0].length) || value), groups.push(tokens = [])), context = false, (match = existingRegistrationRegex.exec(value)) && (context = match.shift(), tokens.push({
          value : context,
          type : match[0].replace(rtrim, " ")
        }), value = value.slice(context.length)), Expr.filter) {
          if (!(!(match = matchExpr[type].exec(value)) || preFilters[type] && !(match = preFilters[type](match)))) {
            context = match.shift();
            tokens.push({
              value : context,
              type : type,
      ...
      return rows ? value.length : value ? Sizzle.error(node) : next(node, groups).slice(0);
      ...
      if (results = results || [], 1 === match.length) {
        if (2 < (tokens = match[0] = match[0].slice(0)).length && "ID" === (token = tokens[0]).type && 9 === context.nodeType && documentIsHTML && Expr.relative[tokens[1].type]) {
          if (!(context = (Expr.find.ID(token.matches[0].replace(value, data), context) || [])[0])) {
            return results;
          }
          if (compiled) {
        ...
        for (; i--;) {
          ...
          if ((f = Expr.find[type]) && (seed = f(token.matches[0].replace(value, data), RE_PSEUDOS.test(tokens[0].type) && testContext(context.parentNode) || context))) {
    ...
    }) || addHandle(options, function(elem, name, n) {
      var val;
      if (!n) {
  ...
  jQuery.each({
    ...
    contents : function(elem) {
      return "undefined" != typeof elem.contentDocument ? elem.contentDocument : (callback(elem, "template") && (elem = elem.content || elem), jQuery.merge([], elem.childNodes));
    }
  }, function(name, i) {
    /**
     * @param {boolean} index
  ...
  jQuery.Callbacks = function(options) {
    var h;
    var s;
    options = "string" == typeof options ? (h = options, s = {}, jQuery.each(h.match(value) || [], function(canCreateDiscussions, $token) {
      /** @type {boolean} */
      s[$token] = true;
  ...
  Data.prototype = {
    ...
    set : function(value, key, str) {
      var name;
      var obj = this.cache(value);
      if ("string" == typeof key) {
        /** @type {string} */
        obj[camelCase(key)] = str;
      } else {
        for (name in key) {
    ...
    remove : function(owner, name) {
      ...
      if (void 0 !== cache) {
        if (void 0 !== name) {
          i = (name = Array.isArray(name) ? name.map(camelCase) : (name = camelCase(name)) in cache ? [name] : name.match(value) || []).length;
          for (; i--;) {
            delete cache[name[i]];
          }
        }
  ...
  jQuery.fn.extend({
    data : function(value, args) {
      ...
      if (void 0 === value) {
        if (this.length && (elements = self.get(elem), 1 === elem.nodeType && !dataPriv.get(elem, "hasDataAttrs"))) {
          i = attrs.length;
          for (; i--;) {
            if (attrs[i] && 0 === (type = attrs[i].name).indexOf("data-")) {
              type = camelCase(type.slice(5));
              add(elem, type, elements[type]);
            }
          }
      ...
      return "object" == typeof value ? this.each(function() {
        ...
        var ret;
        if (elem && void 0 === name) {
          return void 0 !== (ret = self.get(elem, value)) ? ret : void 0 !== (ret = add(elem, value)) ? ret : void 0;
        }
        this.each(function() {
  ...
  var isHidden = function(el, root) {
    return "none" === (el = root || el).style.display || "" === el.style.display && contains(el) && "none" === jQuery.css(el, "display");
  };
  /**
   * @param {!Object} e
   * @param {!Array} obj
  ...
  jQuery.event = {
    global : {},
    add : function(elem, data, handler, event, selector) {
      var handleObjIn;
      var eventHandle;
      var BROWSER_ENGINES;
      var events;
      ...
      if (elemData) {
        ...
        i = (data = (data || "").match(value) || [""]).length;
        for (; i--;) {
          ...
          if (type) {
            ...
            if (!(handlers = events[type])) {
              ...
              if (!(special.setup && false !== special.setup.call(elem, event, h, eventHandle))) {
    ...
    remove : function(elem, data, fn, selector, i) {
      ...
      if (elemData && (events = elemData.events)) {
        i = (data = (data || "").match(value) || [""]).length;
        for (; i--;) {
          if (type = level = (tmp = dre.exec(data[i]) || [])[1], h = (tmp[2] || "").split(".").sort(), type) {
            special = jQuery.event.special[type] || {};
    ...
    special : {
      ...
      click : {
        setup : function(table) {
          var t = this || table;
          return re.test(t.type) && t.click && callback(t, "input") && on(t, "click", returnTrue), false;
        },
        trigger : function(event) {
          var element = this || event;
          return re.test(element.type) && element.click && callback(element, "input") && on(element, "click"), true;
        },
        _default : function(options) {
          var elem = options.target;
          return re.test(elem.type) && elem.click && callback(elem, "input") && dataPriv.get(elem, "click") || callback(elem, "a");
        }
      },
      beforeunload : {
    ...
    clone : function(elem, n, array) {
      ...
      if (!(support.noCloneChecked || 1 !== elem.nodeType && 11 !== elem.nodeType || jQuery.isXMLDoc(elem))) {
        ...
        for (; i < l; i++) {
          ...
          el = destElements[i];
          void 0;
          if ("input" === (undefined = el.nodeName.toLowerCase()) && re.test(o.type)) {
  ...
  !function() {
    ...
    function computeStyleTests() {
      if (div) {
        ...
        res = "1%" !== style.top;
        /** @type {boolean} */
        a = 12 === parseRound(style.marginLeft);
        /** @type {string} */
        div.style.right = "60%";
        /** @type {boolean} */
  ...
  jQuery.extend({
    ...
    removeAttr : function(el, val) {
      ...
      /** @type {number} */
      var callbackCount = 0;
      var callbackVals = val && val.match(value);
  ...
  jQuery.fn.extend({
    addClass : function(value) {
      ...
      if ((current = each(value)).length) {
        for (; o = this[u++];) {
          if (i = getClass(o), n = 1 === o.nodeType && " " + log(i) + " ") {
            /** @type {number} */
            j = 0;
            for (; max = current[j++];) {
              if (n.indexOf(" " + max + " ") < 0) {
    ...
    removeClass : function(value) {
      ...
      if ((current = each(value)).length) {
        for (; o = this[u++];) {
          if (i = getClass(o), e = 1 === o.nodeType && " " + log(i) + " ") {
            /** @type {number} */
            j = 0;
            for (; console = current[j++];) {
              for (; -1 < e.indexOf(" " + console + " ");) {
                /** @type {string} */
                e = e.replace(" " + console + " ", " ");
              }
            }
    ...
    hasClass : function(elem) {
      ...
      for (; o = this[r++];) {
        if (1 === o.nodeType && -1 < (" " + log(getClass(o)) + " ").indexOf(exactLanguageCode)) {
          return true;
        }
      }
      return false;
    ...
    valHooks : {
      ...
      select : {
        ...
        set : function(key, value) {
          ...
          return outputFn || (key.selectedIndex = -1), result;
        }
      }
    }
  });
  ...
  jQuery.fn.extend({
    ...
    serializeArray : function() {
      return this.map(function() {
        ...
        return this.name && !jQuery(this).is(":disabled") && rsubmittable.test(this.nodeName) && !reHasHexPrefix.test(string) && (this.checked || !re.test(string));
  ...
  jQuery.extend({
    ...
    ajax : function(url, options) {
      ...
      if (deferred.promise(jqXHR), s.url = ((url || s.url || location.href) + "").replace(rprotocol, location.protocol + "//"), s.type = options.method || options.type || s.method || s.type, s.dataTypes = (s.dataType || "*").toLowerCase().match(value) || [""], null == s.crossDomain) {
      ...
      jqXHR.setRequestHeader("Content-Type", s.contentType), jqXHR.setRequestHeader("Accept", s.dataTypes[0] && s.accepts[s.dataTypes[0]] ? s.accepts[s.dataTypes[0]] + ("*" !== s.dataTypes[0] ? ", " + $t + "; q=0.01" : "") : s.accepts["*"]), s.headers) {
  ...
  jQuery.fn.load = function(result, value, callback) {
    ...
    return -1 < i && (name = log(result.slice(i)), result = result.slice(0, i)), fn(value) ? (callback = value, value = void 0) : value && "object" == typeof value && (method = "POST"), 0 < $.length && jQuery.ajax({
      url : result,
      type : method || "GET",
      dataType : "html",
      data : value
  ...
  jQuery.offset = {
    setOffset : function(element, options, x) {
      ...
      if (("absolute" === propertyName || "fixed" === propertyName) && -1 < (curCSSTop + curCSSLeft).indexOf("auto")) {
        bottom = (offset = c.position()).top;
        left = offset.left;
      } else {
        /** @type {number} */
        bottom = parseFloat(curCSSTop) || 0;
        /** @type {number} */
        left = parseFloat(curCSSLeft) || 0;
      }
      if (fn(options)) {
      ...
      if (null != options.top) {
        /** @type {number} */
        self.top = options.top - curOffset.top + bottom;
      }
      if (null != options.left) {
        /** @type {number} */
        self.left = options.left - curOffset.left + left;
      }
      if ("using" in options) {
        options.using.call(element, self);
      } else {
        c.css(self);
      }
    }
